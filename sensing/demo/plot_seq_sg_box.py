...
class SpectrogramGUI:
    ...
    def read_next_file(self):
        # Filename format: sensed_fft_frame42_sym25_sc0_size1024.bin
        frame_idx = self.symbol_counter // self.num_symbol_per_frame
        symbol_idx = self.symbol_counter % self.num_symbol_per_frame
        file = f"sensed_fft_frame{frame_idx}_sym{symbol_idx}_sc0_size1024.bin"
    ...
    def read_next_boxes(self):
        # # Filename format: box_frame0-39_sym0-50_sc0-63.csv
        # fliename = f"box_frame*_sym0-{self.num_symbol_per_frame}_sc*.csv"
    ...
    def update_spectrogram(self):
        new_rows = self.read_next_file()
        self.read_next_boxes()
